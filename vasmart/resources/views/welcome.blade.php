...
<!-- Mirrored from demo.hasthemes.com/subas-preview-v1/subas/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jan 2021 09:27:18 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>V.a Smart || Home</title>
                        ...
                        <div class="col-lg-8 d-none d-lg-block">
                            <nav id="primary-menu">
                                <ul class="main-menu text-center">
                                    ...
                                    <li class="mega-parent"><a href="shop.html">Danh Mục</a>
                                        <div class="mega-menu-area clearfix">
                                            <div class="mega-menu-link f-left">
                                                ...
                                                <ul class="single-mega-item">
                                                    <li class="menu-title">Headphones</li>
                                                    <li>
                                                        <a href="#">Sony</a>
                                                    </li>
                                                    <li>
                                    ...
                                    <div class="header-search-inner">
                                        ...
                                        <form action="#">
                                            <div class="top-search-box">
                                                <input type="text" placeholder="Nhập tên sản phẩm tìm kiếm...">
                                                <button type="submit">
                                                    <i class="zmdi zmdi-search"></i>
                                                </button>
                                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title text-left mb-40">
                            <h2 class="uppercase">Hãng nổi bật</h2>
                            ...
                            <div class="col-xl-2 d-block d-xl-block d-lg-none d-md-none">
                                <div class="single-footer">
                                    ...
                                    <ul class="footer-menu">
                                        <li>
                                            <a href="shop.html"><i class="zmdi zmdi-circle"></i><span>Shop</span></a>
                                        </li>
                                        <li>
                                            <a href="blog.html"><i class="zmdi zmdi-circle"></i><span>Blog</span></a>
                                        </li>
                                        <li>
                                            <a href="contact.html"><i class="zmdi zmdi-circle"></i><span>Liên hệ</span></a>
                                        </li>
                                        <li>
                                            <a href="about.html"><i class="zmdi zmdi-circle"></i><span>Về chúng tôi</span></a>
                                        </li>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-3">
                                <div class="single-footer">
                                    ...
                                    <ul class="footer-menu">
                                        ...
                                        <li>
                                            <a href="wishlist.html"><i class="zmdi zmdi-circle"></i><span>Danh sách yêu thích</span></a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="login.html"><i class="zmdi zmdi-circle"></i><span>Đăng ký</span></a>
                                        </li>
                                        <li>
                                            <a href="checkout.html"><i class="zmdi zmdi-circle"></i><span>Thanh toán</span></a>
                                        </li>
